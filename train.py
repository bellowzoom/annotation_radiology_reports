...
parser.add_argument('--data_dir', type=str, default='dataset', help='Directory for jsonl data')
...
parser.add_argument('--train_data', default='/1211/openi_word_tr', help='Name of training file.')
parser.add_argument('--dev_data', default='/1211/openi_word_ts', help='Name of dev file.')
...
parser.add_argument('--indiaction', action='store_false', help='Use indiaction information for decoder.')
parser.add_argument('--concat_indiaction', action='store_true', help='Simply concat indiaction to findings.')
...
parser.add_argument('--save_dir', type=str, default='./saved_models/1211/', help='Root dir for saving models.')
parser.add_argument('--id', type=str, default='words', help='Model ID under which to save models.')
...
# trainer = Trainer(opt=opt, vocab=vocab, emb_matrix=emb_matrix,model_file='saved_models/00/best_model.pt')
...
# 导入已经训练的参数
# pathModel = 'saved_models/c/00/best_model.pt'
# modelCheckpoint = torch.load(pathModel)
# trainer.load_state_dict(modelCheckpoint['state_dict'])
# print('load done~!')
